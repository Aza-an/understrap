						...
						<tr>
							<td colspan="6" class="actions">
								...
								<?php if ( wc_coupons_enabled() ) { ?>
									<div class="coupon">
										<label for="coupon_code"><?php esc_html_e( 'Voucher:', 'understrap' ); ?></label> <input type="text" name="coupon_code" class="input-text form-control" id="coupon_code" value="" placeholder="<?php esc_attr_e( 'Voucher code', 'understrap' ); ?>" /> <button type="submit" class="btn btn-outline-primary" name="apply_coupon" value="<?php esc_attr_e( 'Apply voucher', 'understrap' ); ?>"><?php esc_attr_e( 'Apply voucher', 'understrap' ); ?></button>
										<?php do_action( 'woocommerce_cart_coupon' ); ?>
									</div>
								<?php } ?>

								<button type="submit" class="btn" name="update_cart" value="<?php esc_attr_e( 'Update bag', 'understrap' ); ?>"><?php esc_html_e( 'Update bag', 'understrap' ); ?></button>
